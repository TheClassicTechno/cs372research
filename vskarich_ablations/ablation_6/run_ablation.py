#!/usr/bin/env python3
"""Run all combinations of debate configs x scenario configs for ablation 6.

Scans:
    vskarich_ablations/ablation_6/debate_configs/*.yaml
    vskarich_ablations/ablation_6/scenario_configs/*.yaml
...
Usage:
    python vskarich_ablations/ablation_6/run_ablation.py                    # resume / run remaining
    python vskarich_ablations/ablation_6/run_ablation.py --reset            # wipe status, start fresh
    python vskarich_ablations/ablation_6/run_ablation.py --workers 4        # parallel execution
    python vskarich_ablations/ablation_6/run_ablation.py --retries 2        # retry failed runs up to 2x
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ablation 6 sweep.")
    parser.add_argument(
    ...
    print(f"Ablation 6 sweep: {len(debate_configs)} debate configs x "
    ...
    if args.workers <= 1:
        pbar = tqdm(total=len(remaining), desc="Ablation 6", unit="run")
