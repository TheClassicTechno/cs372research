#!/usr/bin/env python3
"""Run all combinations of debate configs × scenario configs.

Scans:
    vskarich_ablations/ablation_1/debate_configs/*.yaml
    vskarich_ablations/ablation_1/scenario_configs/*.yaml
...
Usage:
    python vskarich_ablations/ablation_1/run_ablation.py                    # resume / run remaining
    python vskarich_ablations/ablation_1/run_ablation.py --reset            # wipe status, start fresh
    python vskarich_ablations/ablation_1/run_ablation.py --workers 4        # parallel execution
    python vskarich_ablations/ablation_1/run_ablation.py --retries 2        # retry failed runs up to 2x
"""
...
def main() -> None:
    ...
    print(f"Ablation sweep: {len(debate_configs)} debate configs x "
    ...
    if args.workers <= 1:
        # ---- Serial execution ----
        pbar = tqdm(total=len(remaining), desc="Ablation", unit="run")
